import { DealService, TargetCompanyService, InvestorService, FundService } from '@generated/financial';
...
export class HybridDealExtractionService {
  ...
  public async extract(text: string, entities: any[]): Promise<HybridDealReport> {
  ...
  private extractDealName(text: string, entities: any[]): string | undefined {
  ...
  private extractInvolvedParties(text: string, entities: any[]): InvolvedParty[] {
