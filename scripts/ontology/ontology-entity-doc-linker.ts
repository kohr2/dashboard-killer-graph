#!/usr/bin/env ts-node
/**
 * Ontology Entity Documentation Linker
 * ------------------------------------
 * Enriches each ontology under `ontologies/**` with documentation hyperlinks
 * by querying the appropriate source (FIBO, O-CREAM, generic text pages).
 *
 * Usage:
 *   npx ts-node scripts/ontology/ontology-entity-doc-linker.ts
 */
