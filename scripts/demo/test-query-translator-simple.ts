...
function parseArguments() {
  ...
  if (args.length === 0) {
    console.log('Usage: npx ts-node scripts/demo/test-query-translator-simple.ts <query> [ontology]');
    console.log('');
    console.log('Examples:');
    console.log('  npx ts-node scripts/demo/test-query-translator-simple.ts "show all persons"');
    console.log('  npx ts-node scripts/demo/test-query-translator-simple.ts "show all companies" procurement');
    console.log('  npx ts-node scripts/demo/test-query-translator-simple.ts "find all contracts" fibo');
    console.log('');
