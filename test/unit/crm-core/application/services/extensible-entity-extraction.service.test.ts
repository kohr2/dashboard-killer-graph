import { ExtensibleEntityExtractionService, ExtensionEntityRegistry } from '../../../../../src/crm-core/application/services/extensible-entity-extraction.service';
import { SpacyEntityExtractionService } from '../../../../../src/crm-core/application/services/spacy-entity-extraction.service';
import { OCreamV2Ontology } from '../../../../../src/crm-core/domain/ontology/o-cream-v2';
...
const { ExtensibleEntityExtractionService: ActualService } = jest.requireActual('../../../../../src/crm-core/application/services/extensible-entity-extraction.service');
